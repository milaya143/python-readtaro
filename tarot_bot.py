...
SERVICES = {
    ...
    "mini":  {"name": "Мини-расклад на вопрос",   "desc": "Отношения / деньги / любая тема · глубокий ответ",      "price": "3 000 ₽","duration": "до 15 мин"},
    "full":  {"name": "Большой расклад",          "desc": "Полная сессия · комплексный анализ ситуации",           "price": "5 000 ₽","duration": "до 60 мин"},
}
...
async def show_faq(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "карты с психологическим пониманием ситуации. Это не предсказание "
...
async def name_received(update: Update, ctx: ContextTypes.DEFAULT_TYPE):
    ...
    if svc_key in ("yn", "day"):
        ...
        prompt = (
            ...
            "Не нужно писать много — пара предложений о том, что тебя сейчас занимает:"
        )
